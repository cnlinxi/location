...
train=pd.read_csv('data/train_ccf_first_round_user_shop_behavior.csv')#train_ccf_first_round_user_shop_behavior.csv
test=pd.read_csv('data/AB_test_evaluation_public.csv')#AB_test_evaluation_public.csv
shop=pd.read_csv('data/ccf_first_round_shop_info.csv')#ccf_first_round_shop_info.csv
